...
class Chat:
    ...
    def logout(self):
        ...
        self.sessions.clear()
        return {'status': 'OK', 'messages': 'User Berhasil Logout'}
...
#     print(j.get_inbox('henderson'))
    ...
    print("isi mailbox dari henderson")
    print(j.get_inbox('henderson'))
    print(j.proses("creategroup {} mantap jiwa".format(tokenid)))
    print(j.proses("joingroup {} mantap jiwa".format(tokenid)))
    print(j.proses("sendgroup {} mantap hello from messi".format(tokenid)))
    print(j.proses("inboxgroup {} mantap".format(tokenid)))
    print(j.proses("sendgroup {} mantap hello again from messi".format(tokenid)))
    print(j.proses("inboxgroup {} mantap".format(tokenid)))
    # print(j.proses("addrealm @a 127.0.0.1 7001"))
    # print(j.proses("realm @a"))
    # print(j.proses("sendrealm {} @a henderson hello from messi".format(tokenid)))
    # print(j.proses("sendgrouprealm {} @a soccer hello from henderson".format(tokenid)))
    # print(j.proses("getrealminbox {} @a".format(tokenid)))
